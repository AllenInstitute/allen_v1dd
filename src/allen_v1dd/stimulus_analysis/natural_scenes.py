...
class NaturalScenes(StimulusAnalysis):
    ...
    def __init__(self, session, plane, ns_type: str="natural_images", trace_type: str="events"):
        ...
        super().__init__(ns_type, ns_type, session, plane, trace_type)
    ...
    def _load_metrics(self):
        ...
        for roi in range(self.n_rois):
            ...
            metrics['mean_responses'] = roi_mean_trial_resp.to_numpy()
            ...
            metrics["z_score_responses"] = (roi_mean_trial_resp.to_numpy() - null_multi_mean[roi]) / null_multi_std[roi]
            ...
            pref_stim_trial_responses = self.trial_responses.sel(roi=roi,image=pref_img) # ROI responses for preferred stimulus condition
            ...
            for imgID in self.image_indices:
                responses = self.trial_responses.sel(roi=roi,image=imgID)
